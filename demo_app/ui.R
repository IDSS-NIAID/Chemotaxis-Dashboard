...
dashboardPage(
  ...
  dashboardBody(tabItems(
    ...
    tabItem(tabName = 'single_experiment_figures',
            ...
            fluidRow(h3("Tracks visualization")),
            fluidRow(
              column(1),
              column(10,
            ...
            fluidRow(h3("Average velocities by treatment")),
            fluidRow(
              column(1),
              column(10,
                     plotOutput('tracks_v'))
            ...
            fluidRow(h3("Angle of migration by channel")),
            fluidRow(
              column(1),
              column(10,
            ...
            fluidRow(h3("Chemotactic efficiency by channel")),
            fluidRow(
              column(1),
              column(10,
                     plotOutput('ce_plot'))
